    ...
    public static class APITokenAuthWebSecurity extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http.requestMatcher(WebSecurityConfig::isTokenAuthentication)
                ...
                .antMatchers(HttpMethod.POST, ADMIN_API + "/events/**").hasAnyRole(OPERATOR, SUPERVISOR, SPONSOR)
                .antMatchers(HttpMethod.POST, ADMIN_API + "/blacklist/**").hasAnyRole(OPERATOR, SUPERVISOR, SPONSOR)
                .antMatchers(HttpMethod.GET, ADMIN_API + "/blacklist/**").hasAnyRole(OPERATOR, SUPERVISOR, SPONSOR)
                .antMatchers(HttpMethod.DELETE, ADMIN_API + "/blacklist/**").hasAnyRole(OPERATOR, SUPERVISOR, SPONSOR)
                .antMatchers(HttpMethod.POST, ADMIN_API + "/reservation/**").hasAnyRole(OPERATOR, SUPERVISOR, SPONSOR)
